...
Исходный код тренировки модели: "3.1. Тренировка модели\TrainDetector.R". (Содержит код для предобработки данных и тренировки текущей модели Random Forest, также закомментированный код для Naive Bayes модели, также, закомментированный код для построения диаграмм "облако слов", пример: "3.1. Тренировка модели\wordClouds.png".)
